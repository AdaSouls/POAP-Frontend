...
export default function CreateEvent() {
  ...
  const isFormValid = () => {
    // Always need Maximum Supply, Event Start Date, Title, Description, and Image URL
    // eventId is auto-generated by backend
    return maxSupply && eventStartDate.trim() && title.trim() && description.trim() && imageUrl.trim();
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isFormValid()) {
      errorFunction(
        "Validation Error",
        "Please fill in all required fields: Maximum Supply, Event Start Date, Title, Description, and Image URL.",
        ""
      );
      return;
    }
